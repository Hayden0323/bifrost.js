...
import type { Bytes, HashMap, Json, Null, Option, Text, U256, U32, U64, Vec, bool, f64, u128, u32, u64 } from '@polkadot/types-codec';
...
declare module '@polkadot/rpc-core/types/jsonrpc' {
  interface RpcInterface {
    ...
    oracle: {
       ...
       **/
      getValue: AugmentedRpc<(providerId: RpcDataProviderId | string, key: OracleKey | { Native: any } | { VToken: any } | { Token: any } | { Stable: any } | { VSToken: any } | { VSBond: any } | { LPToken: any } | { ForeignAsset: any } | { Token2: any } | { VToken2: any } | { VSToken2: any } | { VSBond2: any } | { StableLpToken: any } | string | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<Option<TimestampedValue>>>;
    };
    payment: {
      /**
